<div>
    <form wire:submit.prevent="store">
        ...
        <div class="mt-2" wire:ignore>
            ...
            <textarea wire:model='description' id="description" name="description" rows="2" placeholder="Description..."
                class="w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300
                 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2"></textarea>
        </div>
