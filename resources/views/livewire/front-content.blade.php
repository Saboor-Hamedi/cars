<div>
    <div class=" post__section">
        @foreach ($cars as $car)
        <div
            class="max-w-2xl rounded-lg shadow-sm sm:max-w-md md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto">
            {{-- post image --}}
            <div class="h-32 overflow-hidden rounded-t-lg">
                @if ($car->image)
                <img class="object-cover object-top w-full" src="{{ asset('storage/' . $car->image) }}" alt="Car Image">
                @else
            ...
            <div class="px-2 mb-2">
                ...
                <small>
                    <svg style="color: {{ $color }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
