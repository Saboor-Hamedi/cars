<div class="flex items-center justify-center w-full p-4 mx-auto lg:w-5/6 lg:p-8">
    <div
        class="flex flex-col items-center justify-center w-full p-8 space-y-8 rounded-lg lg:flex-row bg-gray-50 lg:space-y-0 lg:space-x-8 sm:w-full md:w-11/12 lg:w-full">
        <div class="max-w-lg text-center lg:text-left lg:max-w-none">
            <h1 class="text-3xl font-bold sm:text-4xl md:text-5xl">
                <span class="text-blue-500/30">Welcome</span> to my Web Development Portfolio!
            </h1>
            <p class="mt-4 text-sm text-gray-700 sm:text-base md:text-lg">
                I'm Lily Smith, a passionate web developer based in USA. Here, you'll get a glimpse of my journey in the
        ...
        <div class="flex-shrink-0 px-4">
            <img src="storage/default/saboor.jpg" alt="image not found"
                class="object-cover w-64 h-64 rounded-md sm:w-80 sm:h-80 md:w-96 md:h-96">
        </div>
    </div>
</div>