            ...
            <div class="flex flex-wrap text-left lg:text-left">
                <div class="w-full px-4 lg:w-6/12">
                    ...
                    <div class="mt-6 mb-6 lg:mb-0">
                        {{-- twitter --}}
                        <button
                            class="w-10 h-10 mb-2 inline-block rounded-full bg-[#c13584] p-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <span class="me-2 [&>svg]:h-4 [&>svg]:w-4"><svg xmlns="http://www.w3.org/2000/svg"
